...
public class StaffProfile extends AppCompatActivity {
    ...
    TextView fullNameLabel,positionTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_staff_profile);
    ...
    private void showUserData() {
        ...
        positionTxt.setText(userPosition);
    ...
    public void onBackPressed() {
        if(userPosition.equals("Admin")){
            Intent intent = new Intent(StaffProfile.this, AdminDashboard.class);
            intent.putExtra("phone", userPhone);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
        }
        else{
            Intent intent = new Intent(StaffProfile.this, EmployeeDashboard.class);
            intent.putExtra("phone", userPhone);
            startActivity(intent);
            overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
        }
